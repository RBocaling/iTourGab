...
export default function Login() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      await qc.invalidateQueries([""] as any);
    },
    onError: (data) => {
      console.log("dsdss", data?.message);
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          >
            ...
            {mutation.isError && (
              <div className="text-red-400 text-sm">{mutation.data}</div>
            )}
          </motion.form>
          ...
          >
            ...
            <Link to="/register" className="text-muted-foreground text-primary">
              Register
            </Link>
          </motion.div>
        </motion.div>
