...
export default function ItineraryIOS() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("SUBMIT_ITINERARY_PAYLOAD", payload);
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex justify-center px-4 py-10 md:mt-20">
      ...
      <ConfirmDialog
        ...
        primaryLabel={updateMutation.isPending ? "Updating..." : "Yes, update"}
